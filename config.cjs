...
const config = {
  SESSION_ID: process.env.SESSION_ID || "Demo-Slayer~cYZFyRoA#0gJj0m4BE7Pqmkt0Be4PsSeM0FR0VAvc8-Xi0ha-tGs",
  ...
  OWNER_NUMBER: process.env.OWNER_NUMBER || "254111798177",
  SUDO_NUMBER: process.env.SUDO_NUMBER || "254111798177",
